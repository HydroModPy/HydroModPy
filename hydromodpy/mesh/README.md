...
Le package `hydromodpy.mesh` ne construit pas les maillages lui-meme. Il
definit :
...
```python
from hydromodpy.mesh.adapters import from_meshio
...
```python
from hydromodpy.mesh.adapters import from_field_mesh, from_gmsh_planar
