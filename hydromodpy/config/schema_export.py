...
class HydroModPyJsonSchema(GenerateJsonSchema):
    """Schema generator for HydroModPy config schemas."""
...
def export_schema(
    ...
    *,
    ...
    schema = model_cls.model_json_schema(schema_generator=HydroModPyJsonSchema)
