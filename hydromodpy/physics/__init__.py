...
_LAZY_IMPORTS = {
    ...
    "FlowICBottom": "hydromodpy.physics.flow:FlowICBottom",
    "FlowICCustom": "hydromodpy.physics.flow:FlowICCustom",
    "FlowICTop": "hydromodpy.physics.flow:FlowICTop",
    "FlowICTopOffset": "hydromodpy.physics.flow:FlowICTopOffset",
