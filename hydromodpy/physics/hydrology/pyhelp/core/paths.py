...
"""Cache paths and on-demand loader for the HELP3O Fortran extension.

Provides platform-aware cache directory resolution, GitHub-release download
of the matching binary, and a singleton loader exposed through
:func:`ensure_help3o_loaded`.
"""
...
_HELP3O_ERROR: Exception | None = None
HELP3O = None
