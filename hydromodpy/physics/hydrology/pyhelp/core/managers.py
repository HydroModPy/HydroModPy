...
class HelpManager(object):
    ...
    def __init__(
        ...
        self.load_weather_input_data(path_to_precip, path_to_airtemp, path_to_solrad)
    ...
    def _save_connect_tables(self):
        ...
        with open(self.path_connect_tables, "w", encoding="utf-8") as jsonfile:
            json.dump(
                self.connect_tables, jsonfile, indent=2, separators=(",", ": "), ensure_ascii=False
            )
    ...
    def build_help_input_files(
        self, cellnames: list = None, sf_edepth: float = 1, sf_ulai: float = 1, sf_cn: float = 1
    ):
        """
        ...
        """
        self.clear_cache()
        self._generate_d10d11_input_files(cellnames, sf_edepth, sf_ulai, sf_cn)
        self._generate_d4d7d13_input_files(cellnames)

    def _generate_d10d11_input_files(self, cellnames, sf_edepth, sf_ulai, sf_cn):
        """
        ...
        d10_conn_tbl, d11_conn_tbl = write_d10d11_allcells(d10d11_inputdir, d10data, d11data)
    ...
    def _generate_d4d7d13_input_files(self, cellnames):
        ...
        fformat = "{:3.1f}_{:3.1f}.{}"
        args = (
            ("precip", "D4", save_precip_to_HELP, self.precip_data),
    ...
    def _post_process_output(self, output):
        ...
        keys = ["precip", "runoff", "evapo", "perco", "subrun1", "subrun2", "rechg"]
    ...
    def calc_surf_water_cells(self, evp_surf, path_outfile=None, cellnames=None):
        """
    ...
    def get_run_cellnames(self, cellnames=None):
        ...
        cellnames = self.grid["cid"][cellnames][self.grid["nlayer"] > 0].tolist()
