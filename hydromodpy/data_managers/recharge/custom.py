"""Custom data loader for recharge (user-provided CSV files).

Expects a location file (recharge_custom_LOC.*) and chronicle CSVs
...
def load_custom(
    ...
    *,
    ...
    for loc in locations:
        ...
        records.append(
            PointRecord(
                station_id=loc.id, variable="recharge", source="custom",
