...
from hydromodpy.data_managers.wind.config import WindConfig, WindSourceConfig
...
class WindManager(BaseFieldManager):
    ...
    def _fetch_from_source(self, source_cfg: WindSourceConfig):
        if source_cfg.source == "custom":
            from hydromodpy.data_managers.wind.custom import load_custom
            records = load_custom(
                source_cfg,
            ...
            from hydromodpy.data_managers.wind.apis.sim2 import fetch
