...
class PrecipitationManager(BaseFieldManager):
    ...
    def _fetch_from_source(self, source_cfg: PrecipitationSourceConfig):
        if source_cfg.source == "custom":
            from hydromodpy.data_managers.variables.precipitation.custom import load_custom
            ...
            from hydromodpy.data_managers.variables.precipitation.apis.sim2 import fetch
