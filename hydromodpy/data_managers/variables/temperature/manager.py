...
class TemperatureManager(BaseFieldManager):
    ...
    def _fetch_from_source(self, source_cfg: TemperatureSourceConfig):
        if source_cfg.source == "custom":
            from hydromodpy.data_managers.variables.temperature.custom import load_custom
            records = load_custom(
                source_cfg,
            ...
            from hydromodpy.data_managers.variables.temperature.apis.sim2 import fetch
