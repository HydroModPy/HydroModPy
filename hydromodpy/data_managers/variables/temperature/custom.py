"""Custom data loader for temperature (CSV directory, NetCDF, or GeoTIFF)."""
...
from hydromodpy.data_managers.variables.temperature.config import TemperatureSourceConfig
