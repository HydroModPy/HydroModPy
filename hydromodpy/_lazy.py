...
LAZY_IMPORTS: dict[str, str] = {
    ...
    "DemSourceConfig": "hydromodpy.data.variables.dem.config",
    "GeologyConfig": "hydromodpy.data.variables.geology.config",
    "GeologySourceConfig": "hydromodpy.data.variables.geology.config",
    ...
    # Catalog API
    "CatalogIndex": "hydromodpy.results.catalog",
