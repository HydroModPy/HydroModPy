"""
Validate a calibration2 case package before running larger experiments.
...
from hydromodpy.calibration2.core.case_interface import validate_case_implementation
from hydromodpy.calibration2.core.case_orchestrator import run_calibration_case_from_toml
...
def _default_cases_root() -> Path:
    """Return default root where calibration2 cases are stored."""
    return _calibration2_root() / "cases"
...
def _check_case_implementation(case_name: str) -> dict[str, Any]:
    ...
    module_path = f"hydromodpy.calibration2.cases.{case_name}.case_implementation"
...
def check_case(
    ...
    *,
    ...
    cases_root : str | Path | None
        Custom root containing case directories. Defaults to calibration2 cases.
    run_smoke : bool
        ...
        try:
            ...
            payload = run_calibration_case_from_toml(
                ...
                case_implementation=import_module(
                    f"hydromodpy.calibration2.cases.{normalized_name}.case_implementation"
                ).CASE_IMPLEMENTATION,
