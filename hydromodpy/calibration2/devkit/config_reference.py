"""
Generate markdown documentation directly from calibration2 Pydantic schemas.
...
from hydromodpy.calibration2.core.methods_config import METHOD_KWARGS_MODELS
from hydromodpy.calibration2.cases.recession_brutsaert.case_config import (
    BrutsaertChronicleSchema,
)
from hydromodpy.calibration2.cases.reservoir.case_config import ReservoirChronicleSchema
...
def build_config_reference_markdown() -> str:
    """
    Build markdown documentation for calibration2 config schemas.
    ...
    sections: list[str] = []
    sections.append("# Calibration2 Config Reference")
    sections.append("")
    sections.append(
...
def write_config_reference_markdown(
    ...
    output_path : str | Path | None
        Destination markdown file. Uses `calibration2/docs/config_reference.md`
        when omitted.
    """
    # Keep default location close to other calibration2 docs.
    if output_path is None:
        output_path = _calibration2_root() / "docs" / "config_reference.md"
