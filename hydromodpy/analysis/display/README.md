...
`hydromodpy/analysis/display/` centralise les sorties de visualisation et les exports
...
empechant les exports de figures lorsque les runs CI/headless doivent rester
propres.
