...
- `hydromodpy/_cli/workflows.py::run_testbed`
- `hydromodpy/_cli/commands/run.py`
...
python -m ruff check hydromodpy/analysis/testbed hydromodpy/_cli/workflows.py hydromodpy/_cli/commands/run.py tests/unit/launchers/test_testbed_launcher.py tests/unit/launchers/test_hmp_simulation_cli.py
python -m compileall -q hydromodpy/analysis/testbed hydromodpy/_cli/workflows.py hydromodpy/_cli/commands/run.py
```
