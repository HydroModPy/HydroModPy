...
def extract_simulation_child_artifacts(config_path: Path) -> dict[str, Any]:
    ...
    if metrics_payload is not None:
        ...
        artifacts["child_wall_time_seconds"] = safe_float(metrics_payload.get("wall_time_seconds"))
...
def extract_comparison_output_artifacts(
    *,
    ...
    if manifest_payload is not None:
        ...
        artifacts["child_wall_time_seconds"] = safe_float(manifest_payload.get("wall_time_seconds"))
