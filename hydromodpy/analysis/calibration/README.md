...
`hydromodpy/analysis/calibration/` centralizes generic calibration code and runnable
scientific cases.
...
```python
from hydromodpy.analysis.calibration.devkit import (
    scaffold_case,
    check_case,
    run_doctor,
...
1. Create a new case folder under `hydromodpy/analysis/calibration/cases/<your_case>/`.
...
- `hydromodpy/analysis/calibration/cases/reservoir/README.md`
- `hydromodpy/analysis/calibration/cases/groundwater_1d/README.md`
- `hydromodpy/analysis/calibration/cases/recession_brutsaert/README.md`

## Onboarding Docs

- Case cookbook: `hydromodpy/analysis/calibration/docs/case_cookbook.md`
- Config reference: `hydromodpy/analysis/calibration/docs/config_reference.md`

## UML

- Local pointer README: `hydromodpy/analysis/calibration/uml/README.md`
