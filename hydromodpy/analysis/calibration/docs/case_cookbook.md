...
```python
from hydromodpy.analysis.calibration.devkit import scaffold_case

scaffold_case("my_case")
```

This creates `hydromodpy/analysis/calibration/cases/my_case/` with:
...
```python
from hydromodpy.analysis.calibration.devkit import check_case
...
```bash
python hydromodpy/analysis/calibration/cases/my_case/run_calibration.py
```
...
```python
from hydromodpy.analysis.calibration.devkit import run_doctor, format_doctor_report
