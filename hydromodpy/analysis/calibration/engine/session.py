...
from hydromodpy.analysis.calibration.engine.property_arrays import PropertyArraySet
from hydromodpy.analysis.calibration.engine._utils import jsonable as _jsonable
    ...
    def _evaluate_via_launcher(
        ...
        try:
            ...
            request = actualize_candidate(
                ...
                cfg=self.cfg,
                params=key,
                iteration_index=int(iteration_id.split("_")[-1]),
            )
            request = replace(
                request,
