"""
Create a new calibration case from file templates.

This module provides one high-level function, `scaffold_case(...)`, that writes
the standard case skeleton under `analysis/calibration/cases/<case_name>/`.
...
- calibration package folder conventions.
...
def _templates_root() -> Path:
    ...
    return _calibration_root() / "devkit" / "templates" / "case"
...
def scaffold_case(
    ...
    *,
    ...
    """
    Create a new case package under the calibration package using built-in templates.
    ...
    destination : str | Path | None
        ...
        ``hydromodpy/analysis/calibration/cases/<case_name>``.
    overwrite : bool
    ...
    if destination is None:
        case_dir = _calibration_root() / "cases" / normalized_name
    else:
