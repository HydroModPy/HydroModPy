"""
Environment and integration diagnostics for calibration.
...
Who should run it
-----------------
- Developers onboarding on calibration for the first time,
...
def _discover_case_names() -> tuple[str, ...]:
    ...
    cases_dir = _calibration_root() / "cases"
...
def run_doctor() -> dict[str, Any]:
    """
    Collect a lightweight health report for calibration runtime and cases.
...
def format_doctor_report(report: dict[str, Any]) -> str:
    ...
    """
    lines: list[str] = []
    lines.append("Calibration doctor report")
