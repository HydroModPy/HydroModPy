...
:mod:`hydromodpy.display.figures`.
"""
...
def generate_overview_report(state: DataOverviewState) -> list[Path]:
    ...
    from hydromodpy.display.report.summary import compute_overview_summary
...
def _render_panel(
    ...
    **kwargs,
    ...
    from hydromodpy.display.common import _single_axes, make_figure
