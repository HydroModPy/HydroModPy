...
Per-frame rendering is delegated to :mod:`hydromodpy.display.figures`.

The old ``build_concentration_gif`` and ``plot_web_animation`` functions
now live in :mod:`hydromodpy.display.figures.animation` as ``build_gif``
...
def plot_concentration_frames(
    *,
    ...
    - top: concentration temporal evolution (delegated to
      :func:`~hydromodpy.display.figures.timeseries.render_concentration_panel`);
    - bottom: seepage map (delegated to
      :func:`~hydromodpy.display.figures.spatial.render_concentration_map`).
    """
    ...
    from hydromodpy.display.figures.spatial import render_concentration_map
    from hydromodpy.display.figures.timeseries import render_concentration_panel
...
def build_concentration_gif(**kwargs):
    """Deprecated — use :func:`hydromodpy.display.figures.animation.build_gif`."""
    from hydromodpy.display.figures.animation import build_gif
    return build_gif(**kwargs)


def plot_web_animation(**kwargs):
    """Deprecated — use :func:`hydromodpy.display.figures.animation.build_plotly_slider`."""
    from hydromodpy.display.figures.animation import build_plotly_slider
