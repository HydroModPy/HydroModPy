...
_LAZY_IMPORTS: dict[str, str] = {
    ...
    "HydrographicNetwork": "hydromodpy.spatial.geographic.core.hydrographic_network:HydrographicNetwork",
    "HydrographicNetworks": "hydromodpy.spatial.geographic.core.hydrographic_network:HydrographicNetworks",
