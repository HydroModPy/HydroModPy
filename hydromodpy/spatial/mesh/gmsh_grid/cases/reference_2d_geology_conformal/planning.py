...
from hydromodpy.spatial.mesh.gmsh_grid.cases.reference_2d_geology_conformal.scope_resolution import (
    _load_domain_payload,
    _valid_geometry_mask,
)
from hydromodpy.spatial.mesh.gmsh_grid.zone_meshing import (
