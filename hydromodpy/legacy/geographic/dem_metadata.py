"""Read and normalize legacy DEM-derived metadata from watershed rasters."""
...
class LegacyDemMetadata:
    """Legacy DEM-derived runtime attributes consumed across HydroModPy."""
...
def _resolve_lon_lat_metadata(
    *,
    ...
    """Project legacy watershed bounds and centroid to WGS84 when possible."""
...
def read_legacy_dem_metadata(
    *,
    ...
    """Read legacy DEM rasters and rebuild the historical ``Geographic`` metadata."""
