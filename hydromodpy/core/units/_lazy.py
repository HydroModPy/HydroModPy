"""Lazy-import map for ``hydromodpy.core.units`` package facade.
...
LAZY_IMPORTS: dict[str, str] = {
    ...
    "PER_S_CANONICAL_UNITS": "hydromodpy.core.units.leakance:PER_S_CANONICAL_UNITS",
    "convert_to_per_s": "hydromodpy.core.units.leakance:convert_to_per_s",
    "factor_to_per_s": "hydromodpy.core.units.leakance:factor_to_per_s",
    "normalize_per_s_unit": "hydromodpy.core.units.leakance:normalize_per_s_unit",
    "parse_to_per_s": "hydromodpy.core.units.leakance:parse_to_per_s",
    ...
    "AreaSquareMeters": "hydromodpy.core.units.types:AreaSquareMeters",
    ...
    "LengthMeters": "hydromodpy.core.units.types:LengthMeters",
    ...
    "VolumetricFlowM3PerSecond": "hydromodpy.core.units.types:VolumetricFlowM3PerSecond",
