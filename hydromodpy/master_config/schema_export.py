...
from hydromodpy.master_config._registry import root_sections as _root_sections
...
def export_schema(
    ...
    *,
    ...
    schema.setdefault("$comment", "Generated by hydromodpy.master_config.schema_export")
    return schema
