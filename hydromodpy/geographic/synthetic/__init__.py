...
from hydromodpy.geographic.synthetic.config import (
...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    "SyntheticGeographic": (
        "hydromodpy.geographic.synthetic.synthetic_geographic",
        "SyntheticGeographic",
    ),
...
def __getattr__(name: str):
    ...
    if name in _LAZY_EXPORTS:
        ...
        globals()[name] = attr
        return attr
    raise AttributeError(f"module 'hydromodpy.geographic.synthetic' has no attribute {name!r}")
