...
SIM2_VARIABLES: dict[str, Sim2Variable] = {
    ...
    "liquid_precipitation": Sim2Variable(
        "PRELIQ_Q", "liquid_precipitation", "mm/day", "Liquid precipitation (daily cumul 06-06 UTC)"
    ),
    "solid_precipitation": Sim2Variable(
        "PRENEI_Q", "solid_precipitation", "mm/day", "Solid precipitation (daily cumul 06-06 UTC)"
    ),
    ...
    "atmospheric_radiation": Sim2Variable(
        "DLI_Q", "atmospheric_radiation", "J/cm2", "Atmospheric radiation (daily cumul)"
    ),
    "visible_radiation": Sim2Variable(
        "SSI_Q", "visible_radiation", "J/cm2", "Visible radiation (daily cumul)"
    ),
    "soil_moisture_index": Sim2Variable(
        "SWI_Q", "soil_moisture_index", "%", "Soil moisture index (daily mean 06-06 UTC)"
    ),
}
