...
def _run_generation_demo() -> int:
    from hydromodpy.solver.utils.mesh.cartesian_grid.examples.generation.run_grid_demo import (
        main,
    )
...
def _run_discretization_3d_demo() -> int:
    from hydromodpy.solver.utils.mesh.cartesian_grid.examples.discretization.run_demo_3d import (
        main,
    )
