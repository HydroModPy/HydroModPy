...
if __name__ == "__main__":
    ...
    h = Variable(id='h', value=None, description='Hydraulic head', units='m')
    q = Variable(id='q', value=None, description='Flow rate', units='m3/s')
    ...
    drain = BoundaryCondition(id='drain', value=None, description='Drain boundary condition', units='m', type='Cauchy')
    ...
    test.set_parameters({K.id: K, Sy.id: Sy})
