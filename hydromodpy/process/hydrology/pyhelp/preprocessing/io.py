...
from hydromodpy.core.tools.toolbox import transform_coordinates, filter_coordinates_by_shape
...
def make_pyhelp_inputs(grid_base, dem, shp, outdir, *, nc_folder=None, ready_csvs=None, grid_params=None):
...
def export_daily_outputs_to_netcdf(
    *,
    ...
    try:
        ...
        try:
            if grid.crs:
                ds.createVariable("spatial_ref", "i4").spatial_ref = CRS.from_user_input(grid.crs).to_wkt()
        except Exception:
            pass
