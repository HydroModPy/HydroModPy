...
data_path = os.path.join(root_dir, "examples_legacy", "03S_short", "data")
dem_path = os.path.join(data_path, dem_filename)

print("\n" + "="*70)
print("EXAMPLE 03 SHORT - NEW API".center(70))
# ============================================================================
# 1. WATERSHED EXTRACTION
# ============================================================================
...
specific_path = os.path.join(root_dir, "examples_legacy", "03S_short/")
