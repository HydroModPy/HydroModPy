...
regression_path = os.path.join(root_dir, "examples_legacy", "00_quick_test_of_wide_hydromodpy_capabilities/")
data_path = os.path.join(regression_path, "data/")

# The folder out_path is created in the example_path root directory:
out_path = os.getenv("HYDROMODPY_EXAMPLE00_OUT_PATH", os.path.join(root_dir, "examples_legacy", "results"))
