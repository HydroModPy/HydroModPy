...
def run_hydromodpy(watershed_name='11S_short',
                   out_dir_path=os.path.join(root_dir,'examples_legacy','results'),
    ...
    config_init = WorkspaceConfig(
        ...
        data_path=Path(os.path.join(root_dir, "examples_legacy", "11S_short", "data")),
    )
    initializing_object = Workspace(config=config_init)
    
    specific_path = os.path.join(root_dir, "examples_legacy", "11S_short/")
