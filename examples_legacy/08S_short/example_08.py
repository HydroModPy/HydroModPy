...
example_path = os.path.join(root_dir, "examples_legacy", "08S_short/")
...
case = '08S_short'         #name of the folder in examples folder
...
# Ratio to reach
KR = 10000 # hydraulic conductivity divided by recharge
