...
and on the [documentation site](https://hydromodpy.github.io/main/).
...
see the [installation guide](https://hydromodpy.github.io/main/install.html).
...
see the [test families guide](https://hydromodpy.github.io/main/architecture/overview/test-families-and-quality-roles.html).
For GitHub check names and CI triage, see the
[GitHub Actions workflow guide](https://hydromodpy.github.io/main/architecture/ci-workflows.html).
...
- [Configuration reference](https://hydromodpy.github.io/main/user_guide/config_reference/index.html):
  every TOML section, fields, defaults, validators.
- [Architecture](https://hydromodpy.github.io/main/architecture/index.html):
  layer matrix, package maps, runtime handoff.
- [User guide](https://hydromodpy.github.io/main/user_guide/index.html):
  workflows, cookbook, theory, supported data variables.
- [API reference](https://hydromodpy.github.io/main/api/index.html):
