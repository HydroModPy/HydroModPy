...
turned some of them green; when a further one does, the two declarations below
are what must be edited, deliberately. A repaired claim does not disappear from
this file: it moves to ``REPAIRED_STRICT_XFAILS``, where it keeps guarding
against anyone marking it xfail again. All five have moved, and the tier
carries no strict xfail left.
"""
...
REPAIRED_STRICT_XFAILS: dict[str, str] = {
    "test_the_runtime_state_survives_a_process_boundary": "F8b",
