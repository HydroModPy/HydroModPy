...
class TestParamsHashCache:
    ...
    def test_put_overwrites(self):
        ...
        cache.put("abc", "sim-1")
        cache.put("abc", "sim-2")
        assert cache.get("abc") == "sim-2"

    def test_cache_hit_returns_sim_id(self):
        """Two evaluations with identical params → same sim_id."""
        cache = ParamsHashCache()
