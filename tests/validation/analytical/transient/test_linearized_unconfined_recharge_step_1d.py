...
@pytest.mark.transient
@pytest.mark.petsc
def test_linearized_unconfined_recharge_step_1d_petsc_ts_vi_obstacle_matches_reference_profiles() -> (
    None
):
...
@pytest.mark.transient
@pytest.mark.petsc
def test_linearized_unconfined_recharge_step_1d_petsc_vi_obstacle_matches_reference_profiles() -> (
    None
):
    """Run the analytical recharge-step case through PETSc SNESVI obstacle."""
    _require_linux_petsc4py()
