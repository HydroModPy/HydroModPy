"""Validate the deep-aquifer recharge-step case against its analytical reference."""
...
def test_linearized_unconfined_recharge_step_deep_1d_matches_reference_profiles(
    solver: str,
    ...
    comparison = run_linearized_unconfined_recharge_step_deep_comparison(
