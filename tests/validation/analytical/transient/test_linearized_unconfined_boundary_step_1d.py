...
def test_linearized_unconfined_boundary_step_1d_matches_reference_profiles(solver: str, require_modflow: bool, require_modflow6: bool) -> None:
    ...
    comparison = run_linearized_unconfined_boundary_step_comparison(caller_file=__file__, solver=solver)
