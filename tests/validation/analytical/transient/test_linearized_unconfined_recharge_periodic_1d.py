...
@pytest.mark.slow
def test_linearized_unconfined_recharge_periodic_1d_matches_reference_profiles() -> None:
    ...
    comparison = run_linearized_unconfined_recharge_periodic_comparison(caller_file=__file__)
