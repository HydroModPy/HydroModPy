"""Validate the linearized unconfined periodic-recharge case against its analytical reference."""
...
def test_linearized_unconfined_recharge_periodic_1d_matches_reference_profiles(solver: str, require_modflow: bool, require_modflow6: bool) -> None:
    ...
    comparison = run_linearized_unconfined_recharge_periodic_comparison(caller_file=__file__, solver=solver)
