"""Validate the steady Boussinesq recharge piecewise-K case."""
...
def test_boussinesq_uniform_recharge_piecewise_k_1d_matches_reference_profile(
    ...
    comparison = run_boussinesq_uniform_recharge_piecewise_k_comparison(
