"""Validate the steady sloping-substratum uniform-recharge case."""
...
def test_boussinesq_sloping_substratum_uniform_recharge_1d_matches_reference_profile(
    solver: str,
    require_modflow: bool,
    require_modflow6: bool,
) -> None:
    """Run the case and compare the final head profile to the reference."""
    ...
    comparison = run_boussinesq_sloping_substratum_uniform_recharge_comparison(
