...
@pytest.mark.steady
@pytest.mark.fast
def test_boussinesq_divide_fixed_head_piecewise_k_1d_matches_reference_profile() -> None:
    ...
    comparison = run_boussinesq_divide_fixed_head_piecewise_k_comparison(caller_file=__file__)
