"""Validate the steady Boussinesq divide piecewise-K case."""
...
def test_boussinesq_divide_fixed_head_piecewise_k_1d_matches_reference_profile(solver: str, require_modflow: bool, require_modflow6: bool) -> None:
    ...
    comparison = run_boussinesq_divide_fixed_head_piecewise_k_comparison(caller_file=__file__, solver=solver)
