"""Validate a steady Dupuit fixed-head case against its analytical profile."""
...
@pytest.mark.steady
@pytest.mark.fast
def test_dupuit_fixed_head_1d_matches_reference_profile() -> None:
    ...
    comparison = run_dupuit_fixed_head_comparison(caller_file=__file__)
