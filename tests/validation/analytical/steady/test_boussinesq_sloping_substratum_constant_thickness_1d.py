"""Validate the steady sloping-substratum constant-thickness case."""
...
def test_boussinesq_sloping_substratum_constant_thickness_1d_matches_reference_profile(
    solver: str,
    ...
    comparison = run_boussinesq_sloping_substratum_constant_thickness_comparison(
