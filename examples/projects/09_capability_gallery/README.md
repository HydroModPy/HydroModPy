...
- `launcher_simulation/nancon_transient_nwt/`: selected figures from the
  observed-basin `02_nancon_watershed/run_transient_nwt.toml` example, focused
  on hydrography-aware diagnostics.
