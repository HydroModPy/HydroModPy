...
for k in k_values:
    ...
    nc = preprocessing_pyhelp(
        workdir = os.path.join(pyhelp_workdir, f"{watershed_name}_sim_{k}"),
        outpath = os.path.join(pyhelp_workdir, f"{watershed_name}_sim_{k}"),
        #grid_csv = grid_base_csv,
        ready_csvs = ready_csvs,
...
csv_path = pyhelp_workdir + "/help_example_daily_mean.csv"
