...
dem_path = data_path + "MNT_gouville_25m.tif" #MNT_gouville_25m.tif
oceanic_path = data_path + 'oceanic/'
recharge_path = data_path + 'recharge/_REC_D.csv'
shape_calib_zones_path = os.path.join(data_path, 'shapefile', 'calib_zones.shp') #param_zones.shp
...
BV.climatic.update_recharge(rec/1000, sim_state='steady')
...
BV.oceanic.update_MSL(sea_level_mean)
...
hyd_cond_1 = 11.7 # m/day
hyd_cond_2 = 5.6 # m/day
porosity_1 = 7.5 / 100 # -
porosity_2 = 30 / 100 # -
