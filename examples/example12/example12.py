...
if __name__ == '__main__':
    ...
    if pyhelp_activated == True:
        ...
        # sim2_file_precip = 'x' # netcdf propre
        # sim2_file_temp = 'x' # netcdf propre
        # sim2_file_sr = 'x' # netcdf propre
        
        dem_path_modflow = geographic.watershed_box_buff_dem
        
        #DEM generated by hydromodpy, is resampled during pyhelp preprocessing
        #to 250m for computation efficiency
        dem_path_pyhelp = Path(cfg.initializing.stable_folder, "geographic", "watershed_box_buff_dem.tif")
        ...
        ready_climatic_csvs = [
            os.path.join(data_path, "pyhelp_precip_input_data.csv"),
            os.path.join(data_path, "pyhelp_airtemp_input_data.csv"),
            os.path.join(data_path, "pyhelp_solrad_input_data.csv")
        ]
