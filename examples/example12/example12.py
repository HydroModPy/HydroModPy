...
if __name__ == '__main__':
    ...
    if pyhelp_activated == True:
        ...
        nc_folder = [
            Path(cfg.initializing.stable_folder, "climatic", "PRETOT_SIM2_20000101_20091231.nc"),
            Path(cfg.initializing.stable_folder, "climatic", "T_SIM2_20000101_20091231.nc"), 
            Path(cfg.initializing.stable_folder, "climatic", "DLI_SIM2_20000101_20091231.nc")   
            ]
