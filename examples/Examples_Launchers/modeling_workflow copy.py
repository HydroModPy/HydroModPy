...
def modpath(geographic, settings, model_modflow, initializing, results, for_calib=True):
    ...
    try:
        ...
        model_modpath = Modpath(geographic,
                                ...
                                zone_partic=results.get('zone_partic', 'domain'),
                                cell_div=results.get('cell_div', 10),
                                zloc_div=results.get('zloc_div', 1),
                                bore_depth=results.get('bore_depth'),
                                track_dir=results.get('track_dir', 'backward'),
                                sel_random=results.get('sel_random'),
                                sel_slice=results.get('sel_slice'))
        ...
        return {'model_modpath': model_modpath, 'success': success_modpath}
...
def mt3dms(geographic, climatic, model_modflow, initializing, scenario='s1', for_calib=True):
    ...
    try:
        ...
        return {'model_mt3dms': model_mt3dms, 'success': success_mt3dms}
