#!/usr/bin/env bash
# run_migration_P11_tests.sh — Phase P11 : Tests : pyramide 4 niveaux + TOLERANCES.md + CI 4 profils
# Usage : ./run_migration_P11_tests.sh   (tmux recommandé)
...
PHASE_NAME="P11_tests"
BRANCH="migration/P11-tests"
...
log "  Branche : $BRANCH"
log "  Spec    : architecture_cible/14_plan_migration.md §16"
log "  Estim   : 48h"
log "================================================================"
...
Tu exécutes la phase P11 du plan de migration HydroModPy.

PROJET : /home/bb/Documents/01_Git_Repository/02-HydroModPy-dev
BRANCHE COURANTE : migration/P11-tests (déjà créée)
PLAN DE MIGRATION : architecture_cible/14_plan_migration.md — section §16

Lis la section §16 du plan de migration (objectif, fichiers, tests, critère de
...
2. /home/bb/Documents/01_Git_Repository/02-HydroModPy-dev/architecture_cible/14_plan_migration.md (section §16)
3. Les documents sources référencés dans la section §16 du plan
   (typiquement : un document dans architecture_cible/ + un dans audit_code/).

CONTRAINTES GÉNÉRALES :
- Écrire TOUT en français technique.
- Commits atomiques avec messages "[P11] <action>" en anglais.
...
- Rapporter à la fin : LOC ajoutées, LOC supprimées, tests ajoutés, tests
  cassés (doit être 0), preuves de succès selon critère de la section §16.

CRITÈRE DE SUCCÈS : voir architecture_cible/14_plan_migration.md §16 (sous-section
