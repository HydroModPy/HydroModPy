...
# HydroModPy
from watershed import climatic, driasclimat, driaseau, geographic, geology, hydraulic, hydrography, hydrometry, intermittency, oceanic, piezometry, lakeres, streamflow_seepage, settings, safransurfex, subbasin, transport
...
class Watershed:
    ...
    def __init__(self, 
        ...
        if load==True:
            ...
            logging.warning("Python object was not loaded; it was created from scratch as requested")
            # Definition of the watershed
            self.__init_object()
            # Creation of the watershed defined at the previous line
            self.__create_object()
