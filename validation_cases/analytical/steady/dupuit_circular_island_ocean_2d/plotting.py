"""Plotting helpers for the steady circular-island ocean validation case."""
...
def plot_dupuit_circular_island_ocean_comparison(
    comparison: DupuitCircularIslandOceanComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    fig.suptitle("Dupuit Circular-Island Ocean 2D Validation", fontsize=sizes["suptitle"])
