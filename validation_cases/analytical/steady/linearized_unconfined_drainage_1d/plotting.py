"""Plotting helpers for the steady linearized unconfined drainage case."""
...
from .comparison import LinearizedUnconfinedDrainageComparison
...
def plot_linearized_unconfined_drainage_comparison(
    comparison: LinearizedUnconfinedDrainageComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    params_line = (
        ...
        f"z_d={float(reference_cfg['drainage_elevation_m']):.2f} m   "
    ...
    fig.suptitle("Linearized Unconfined Drainage 1D Validation", fontsize=13)
