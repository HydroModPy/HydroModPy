"""Plotting helpers for the sloping-substratum constant-thickness case."""
...
def plot_boussinesq_sloping_substratum_constant_thickness_comparison(
    comparison: BoussinesqSlopingSubstratumConstantThicknessComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    params_line = (
        ...
        f"b*={float(reference_cfg['target_saturated_thickness_m']):.2f} m   "
    ...
    fig.suptitle("Boussinesq Sloping-Substratum Constant-Thickness 1D Validation", fontsize=13)
