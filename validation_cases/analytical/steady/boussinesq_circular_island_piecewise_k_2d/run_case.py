"""Run the steady circular-island piecewise-K validation case and plot the comparison."""
...
from validation_cases.analytical.steady.boussinesq_circular_island_piecewise_k_2d.plotting import (
    plot_boussinesq_circular_island_piecewise_k_comparison,
)
from validation_cases.shared.cli import run_case_main


DEFAULT_FIGURE_NAME = "boussinesq_circular_island_piecewise_k_2d_validation.png"
RUN_DESCRIPTION = "Run the circular-island piecewise-K validation case and plot the result."
...
def main(argv: list[str] | None = None) -> None:
    run_case_main(
        ...
        run_comparison=run_boussinesq_circular_island_piecewise_k_comparison,
        plot_comparison=plot_boussinesq_circular_island_piecewise_k_comparison,
