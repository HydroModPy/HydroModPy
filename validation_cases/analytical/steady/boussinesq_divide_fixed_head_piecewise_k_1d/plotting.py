"""Plotting helpers for the steady divide piecewise-K validation case."""
...
from .comparison import BoussinesqDivideFixedHeadPiecewiseKComparison
...
def plot_boussinesq_divide_fixed_head_piecewise_k_comparison(
    comparison: BoussinesqDivideFixedHeadPiecewiseKComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    fig.suptitle("Boussinesq Divide-Fixed-Head Piecewise-K 1D Validation", fontsize=13)
