"""Run the steady Dupuit divide-river validation case and plot the comparison."""
...
from validation_cases.analytical.steady.dupuit_divide_river_1d.plotting import (
    plot_dupuit_divide_river_comparison,
)
from validation_cases.shared.cli import run_case_main


DEFAULT_FIGURE_NAME = "dupuit_divide_river_1d_validation.png"
RUN_DESCRIPTION = "Run the Dupuit divide-river validation case and plot the result."
...
def main(argv: list[str] | None = None) -> None:
    run_case_main(
        ...
        run_comparison=run_dupuit_divide_river_comparison,
        plot_comparison=plot_dupuit_divide_river_comparison,
