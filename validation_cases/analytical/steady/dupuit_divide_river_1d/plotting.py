"""Plotting helpers for the steady Dupuit divide-river validation case."""
...
from .comparison import DupuitDivideRiverComparison
...
def plot_dupuit_divide_river_comparison(
    comparison: DupuitDivideRiverComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    params_line = (
        ...
        f"west=no-flow   "
        f"h_r={float(reference_cfg['river_head']):.2f} m   "
    ...
    fig.suptitle("Dupuit Divide-River 1D Validation", fontsize=13)
