"""Run the steady fixed-head piecewise-K validation case and plot the comparison."""
...
from validation_cases.analytical.steady.boussinesq_fixed_head_piecewise_k_1d.plotting import (
    plot_boussinesq_fixed_head_piecewise_k_comparison,
)
from validation_cases.shared.cli import run_case_main


DEFAULT_FIGURE_NAME = "boussinesq_fixed_head_piecewise_k_1d_validation.png"
RUN_DESCRIPTION = "Run the fixed-head piecewise-K validation case and plot the result."
...
def main(argv: list[str] | None = None) -> None:
    run_case_main(
        ...
        run_comparison=run_boussinesq_fixed_head_piecewise_k_comparison,
        plot_comparison=plot_boussinesq_fixed_head_piecewise_k_comparison,
