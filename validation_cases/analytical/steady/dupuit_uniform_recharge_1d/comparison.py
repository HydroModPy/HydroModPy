"""Comparison workflow for the steady Dupuit uniform-recharge validation case."""
...
class DupuitUniformRechargeComparison:
...
def build_dupuit_uniform_recharge_comparison(
    *,
    result: ValidationRunResult,
    ...
    analytical_profile = expected_dupuit_uniform_recharge_profile(
    ...
    return DupuitUniformRechargeComparison(
        result=result,
...
def run_dupuit_uniform_recharge_comparison(
    *,
    ...
    if normalized_solver == "boussinesq":
        result = run_boussinesq_dupuit_uniform_recharge_case(
    ...
    return build_dupuit_uniform_recharge_comparison(
        result=result,
        metadata=metadata,
