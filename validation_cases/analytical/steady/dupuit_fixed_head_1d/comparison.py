...
class DupuitFixedHeadComparison:
...
def build_dupuit_fixed_head_comparison(
    *,
    result: ValidationRunResult,
    ...
    analytical_profile = expected_dupuit_fixed_head_profile(
    ...
    return DupuitFixedHeadComparison(
        result=result,
...
def run_dupuit_fixed_head_comparison(
    *,
