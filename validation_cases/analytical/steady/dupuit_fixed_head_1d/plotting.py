"""Plotting helpers for the steady Dupuit fixed-head validation case."""
...
def plot_dupuit_fixed_head_comparison(
    comparison: DupuitFixedHeadComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    fig.suptitle("Dupuit Fixed-Head 1D Validation", fontsize=13)
