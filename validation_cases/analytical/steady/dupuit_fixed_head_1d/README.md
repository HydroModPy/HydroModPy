...
python -m validation_cases.analytical.steady.dupuit_fixed_head_1d.run_case --solver boussinesq --no-show
python -m validation_cases.analytical.steady.dupuit_fixed_head_1d.run_case --solver petsc --no-show
