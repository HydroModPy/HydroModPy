...
CASE_ID = "boussinesq_sloping_substratum_fixed_head_1d"
NX = 40
NY = 5
LENGTH_X_M = 400.0
WIDTH_Y_M = 50.0
...
def run_boussinesq_sloping_substratum_fixed_head_case(
    *,
    ...
    return run_boussinesq_uniform_strip_case(
        ...
        plan_description="Steady 1D strip with a sloping impermeable bottom and general fixed heads.",
        flow_regime="steady",
    )


__all__ = ["run_boussinesq_sloping_substratum_fixed_head_case"]
