"""Comparison workflow for the steady recharge piecewise-K validation case."""
...
class BoussinesqUniformRechargePiecewiseKComparison:
...
def build_boussinesq_uniform_recharge_piecewise_k_comparison(
    *,
    result: ValidationRunResult,
    ...
    analytical_profile = expected_boussinesq_uniform_recharge_piecewise_profile(
    ...
    return BoussinesqUniformRechargePiecewiseKComparison(
        result=result,
...
def run_boussinesq_uniform_recharge_piecewise_k_comparison(
    *,
