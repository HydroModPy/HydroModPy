"""Plotting helpers for the steady recharge piecewise-K validation case."""
...
from .comparison import BoussinesqUniformRechargePiecewiseKComparison
...
def plot_boussinesq_uniform_recharge_piecewise_k_comparison(
    comparison: BoussinesqUniformRechargePiecewiseKComparison,
    *,
    output_png: str | Path,
    show_plot: bool = True,
    dpi: int = 160,
    ...
    fig.suptitle("Boussinesq Uniform-Recharge Piecewise-K 1D Validation", fontsize=13)
