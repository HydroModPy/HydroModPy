"""Comparison workflow for the 1D linearized unconfined recharge-step deep case."""
...
from .reference import expected_linearized_unconfined_recharge_step_deep_profiles
from .runtime_boussinesq import (
    run_boussinesq_linearized_unconfined_recharge_step_deep_case,
)
...
def build_linearized_unconfined_recharge_step_deep_comparison(
    *,
    result,
    ...
    analytical_profiles = expected_linearized_unconfined_recharge_step_deep_profiles(
        x=x,
...
def run_linearized_unconfined_recharge_step_deep_comparison(
    *,
    ...
    if normalized_solver == "boussinesq":
        result = run_boussinesq_linearized_unconfined_recharge_step_deep_case(
    ...
    return build_linearized_unconfined_recharge_step_deep_comparison(result=result, solver=solver)
