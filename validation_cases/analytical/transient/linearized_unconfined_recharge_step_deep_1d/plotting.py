"""Plotting helpers for the deep-aquifer recharge-step case."""
...
def plot_linearized_unconfined_recharge_step_deep_comparison(
    ...
    *,
    ...
    return plot_transient_head_1d_comparison(
        ...
        title="Linearized Unconfined 1D Validation - Recharge Step (Deep Aquifer)",
