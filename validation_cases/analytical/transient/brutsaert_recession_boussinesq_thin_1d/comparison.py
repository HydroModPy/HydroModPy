"""Comparison workflow for the thin-aquifer Brutsaert recession case."""
...
def build_brutsaert_recession_boussinesq_thin_comparison(
    *,
    result,
    metadata: dict | None = None,
    tolerances: dict | None = None,
) -> BrutsaertRecessionComparison:
    """Load one completed run and compare it to the nonlinear Brutsaert recession."""
...
def run_brutsaert_recession_boussinesq_thin_comparison(
    *,
    ...
    if normalized_solver == "boussinesq":
        result = run_boussinesq_brutsaert_recession_boussinesq_thin_case(
    ...
    return build_brutsaert_recession_boussinesq_thin_comparison(
        result=result,
        metadata=metadata,
        tolerances=tolerances,
    )
...
__all__ = [
    "build_brutsaert_recession_boussinesq_thin_comparison",
