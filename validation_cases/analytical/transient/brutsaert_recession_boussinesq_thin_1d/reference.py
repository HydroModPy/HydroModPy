"""Reference parameters for the thin-aquifer Brutsaert recession case."""
...
def build_parameter_lines(metadata: dict | None = None) -> tuple[str, ...]:
    """Return short figure footer lines describing the thin Brutsaert setup."""
    ...
    return (
        ...
        f"A={params['watershed_area_m2']:.1f} m2   L={params['channel_length_m']:.1f} m   A/L={params['watershed_area_m2'] / params['channel_length_m']:.1f} m",
