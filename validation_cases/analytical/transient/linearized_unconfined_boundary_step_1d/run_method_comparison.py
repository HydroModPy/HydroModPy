"""Run a same-support method comparison for the transient boundary-step case."""
...
DEFAULT_OUTPUT_ROOT = CASE_DIR / "method_comparison" / DEFAULT_COMPARISON_ID
DEFAULT_CONFIG_PATH = CASE_DIR / ".__runtime_method_comparison_boundary_step.toml"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--reuse",
        action="store_true",
        help="Reuse existing variant run folders instead of relaunching the solvers.",
    )
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = MethodComparisonLauncher(DEFAULT_CONFIG_PATH).run()
