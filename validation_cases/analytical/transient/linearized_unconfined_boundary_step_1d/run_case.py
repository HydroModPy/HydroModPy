"""Run the 1D linearized unconfined boundary-step validation case and plot it."""
...
from validation_cases.analytical.transient.linearized_unconfined_boundary_step_1d.plotting import (
    plot_linearized_unconfined_boundary_step_comparison,
)
from validation_cases.shared.cli import run_case_main


DEFAULT_FIGURE_NAME = "linearized_unconfined_boundary_step_1d_validation.png"
RUN_DESCRIPTION = "Run the 1D linearized unconfined boundary-step validation case."
...
def main(argv: list[str] | None = None) -> None:
    run_case_main(
        ...
        run_comparison=run_linearized_unconfined_boundary_step_comparison,
        plot_comparison=plot_linearized_unconfined_boundary_step_comparison,
