...
FAMILY_SPECS: tuple[ManagedMeshFamilySpec, ...] = (
    ManagedMeshFamilySpec(
        ...
        launcher_config_path="launchers/mesh_catchment/config_s3_10km2.toml",
    ...
    ManagedMeshFamilySpec(
        ...
        scale="100km2",
        variant="geology_rivers_buffer30",
        launcher_config_path="launchers/mesh_catchment/config_headwater_100km2.toml",
    ...
    ManagedMeshFamilySpec(
        ...
        scale="100km2",
        variant="geology_rivers_buffer30",
        launcher_config_path="launchers/mesh_catchment/config_s3_100km2.toml",
    ...
    ManagedMeshFamilySpec(
        ...
        scale="1000km2",
        variant="geology_rivers_buffer30",
        launcher_config_path="launchers/mesh_catchment/config_1000km2.toml",
