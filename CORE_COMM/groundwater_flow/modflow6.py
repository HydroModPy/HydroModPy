...
import numpy as np
# import topography
from watershed.data import oceanic
...
class Modflow6:
  ...
  #%% INIT
    ...
    def pre_processing(self):
        sim = flopy.mf6.MFSimulation(sim_name=self.model_name, version='mf6', exe_name='bin/mf6.exe', sim_ws=self.full_path)
        ...
        for kper in range(self.nper):
            ...
            self.oc = flopy.modflow.ModflowOc(self.mf, stress_period_data=stress_period_data,
