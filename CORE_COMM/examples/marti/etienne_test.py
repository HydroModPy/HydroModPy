...
# General paths
root_path= "C:/Users/Dell/Documents/Tarapaca/data/"

# Specific paths
hydrology_path = root_path + 'HYDROLOGY' # cours d'eau
modflow_path = root_path + 'MODFLOW' # executable + bin
dem_path = root_path + "/DEM/" + "SRTM_90M_Tarapaca_UTM.tif"
surfex_path = None
...
# Results paths
out_path = "C:/Users/Dell/Documents/Tarapaca/out/"
...
# Launch model
BV.run_modflow(ident=name_model, sea_level=0, lay_number=1, modpath_sim=True)

#%% CALIBRATION

BV.calib_dichotomy(ident=None, calib=True, type_river='streams', climatic=recharge,
