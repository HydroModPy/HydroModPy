...
def clip_netcdf(self, data_folder, path_qgis, shp_path):
    ...
    ds.rio.write_crs('epsg:4326',inplace = True) # coordinates ref system of the input file
    
    x_res = 30 # resolution of the otput file
    x_min = 280000 # x-coordinate of the top left corner (coordinates of the output file)
    y_res = 30 # resolution of the otput file
    y_max = 2583000 # y-coordinate of the top left corner
    ...
    ds_reproj.to_netcdf(r'C:\Users\Lucas\Desktop\HYDROMODPY\_data\DEM\19860820-19860824_reproj.nc') # save to netcdf
