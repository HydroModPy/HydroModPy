...
if user == 'Ronan':
    ...
    data_path = "D:/Users/abherve/SIMULATIONS/RONNY/_data/"
    # Path where the results will be stored
    out_path = "D:/Users/abherve/SIMULATIONS/RONNY/"
...
dem_name = "demn7_proj.tif"  # name of dem
from_shp = []  # specify a path if process start from a given shapefile
from_dem = data_path + dem_name  # True or False if the process start from a given DEM of xyz file
...
x = imageio.imread(BV.geographic.watershed_dem)
plt.imshow(x)
...
model_name = 'test7'  # just a string
...
lay_number = 25  # vertical discrtization
...
BV.hydrodynamic.update_nlay(lay_number) # 1
BV.hydrodynamic.update_bottom(None) # 1
...
for model_name, flow_model in zip([model_name], [flow_model]):
    print(model_name)
...
BV.forcing.update_recharge(0.5 / 365, sim_state=sim_state)
...
# hds = bf.HeadFile('D:/Users/abherve/SIMULATIONS/RONNY/test/results_simulations/test7/test7.hds')
