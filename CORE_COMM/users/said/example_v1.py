...
if user == 'Ronan':
    ...
    data_path = "D:/Users/abherve/ONEDRIVE/OneDrive - Université de Rennes 1/HYDRODATAPY/HydroDataPy/SAID/"
    # Path where the results will be stored
    out_path = "D:/Users/abherve/SAID/"
...
watershed_name = 'Outlet'
print('##### '+watershed_name.upper()+' #####')

dem_name = "SRTM_DEM30m.tif"  # name of dem
...
types_obs = ['Orontes_waterway_reprojected']
...
new_dem_path = dems_path + "SRTM_DEM30m_resampled.tif"
