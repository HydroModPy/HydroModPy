...
class Watershed:
    ...
    def __init__(self, watershed_name: str, dem_path: str, 
                 ...
                 hydrometry_path: str = None, intermittency_path: str = None,
                 piezometry_path: bool = False, modflow_path: str = None,
                 subbasin_path: bool = False,
    ...
    def create_object(self):
        ...
        if self.intermittency_path != None:
