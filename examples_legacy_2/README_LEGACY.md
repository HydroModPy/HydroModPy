...
Son contenu est **non fonctionnel** avec l'API actuelle :
...
Il est conservé à titre de trace et pour comparaison ponctuelle. Il
sera supprimé en v0.6.

Pour les exemples à jour, voir `examples/` à la racine du dépôt et son
`README.md` d'index.
