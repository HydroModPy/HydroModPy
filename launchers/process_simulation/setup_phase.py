"""Setup phase for the process-simulation launcher.
...
later process runs. Extracted from ``HydroModPyLauncher`` to allow independent
testing and to keep the launcher a thin orchestrator.
"""
