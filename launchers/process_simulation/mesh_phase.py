"""Mesh phase for the process-simulation launcher.
...
Extracted from ``HydroModPyLauncher`` to allow independent testing and to
keep the launcher a thin orchestrator.
"""
