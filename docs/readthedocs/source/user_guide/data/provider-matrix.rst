...
For the complete generated field list, use
:doc:`../../api/hydromodpy-data`. The generated pages are useful when you need
every default value, while this page is the user-facing selection guide.
