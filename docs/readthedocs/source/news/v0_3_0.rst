...
- Some third-party packages (e.g., ``hydroeval``) are no longer installed because
  they do not support Python 3.11+. Expect to adjust your own scripts accordingly.
...
.. dropdown:: Heads-up for script authors
   :color: warning
   :icon: alert
