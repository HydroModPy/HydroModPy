...
.. code-block:: text
   ...
   docs/readthedocs/source/_static/solvers/boussinesq/formulation_comparison/
   ...
   docs/readthedocs/source/scientific/solvers/flow/boussinesq/
...
``docs/readthedocs/source/_static/capability_gallery/code_comparison`` and
...
2. republish only stable summary assets under
   ...
   ``docs/readthedocs/source/_static/solvers/boussinesq``;
