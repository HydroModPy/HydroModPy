...
.. code-block:: bash
   ...
   python -m launchers method-comparison run examples/projects/launcher_simulation/run_method_comparison_mf6_vs_nwt_same_regular_mesh_moderate.toml
...
.. list-table::
   ...
   * - ``[method_comparison] comparison_id``
     ...
     - ``examples/projects/launcher_simulation/run_method_comparison_mf6_vs_nwt_same_regular_mesh_moderate.toml``
