...
.. seealso::
   Read :doc:`How to read gallery, comparison, and validation pages </getting_started/reading-results-pages>` if you want the parameter mapping, a recommended reading order, and the first modifications to try.
...
- ``docs/readthedocs/source/_static/capability_gallery/validation/modflow6_irregular_tri_xt3d_method_choice_tradeoff.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/modflow6_irregular_tri_xt3d_method_choice_report.json``
- ``docs/readthedocs/source/_static/capability_gallery/validation/modflow6_irregular_tri_xt3d_method_choice_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
