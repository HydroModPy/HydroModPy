...
- Integrated-discharge recession behavior across MODFLOW-NWT, MODFLOW 6, MODFLOW 6 irregular triangles, and the local Boussinesq runtime in the nonlinear regime
...
.. tab-set::
   ...
   .. tab-item:: Boussinesq
      ...
      **Metrics**
      ...
      - Cross-row head spread: 8.12e-16 m
...
- ``docs/readthedocs/source/_static/capability_gallery/validation/brutsaert_recession_boussinesq_thin_1d__modflow6_irregular_tri.png``
