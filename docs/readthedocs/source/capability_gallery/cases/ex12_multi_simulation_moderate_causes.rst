...
- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes_comparison_manifest.json``
- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes_comparison_metrics.json``
- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes_observables.csv``
- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes_summary_metrics.csv``
- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes_difference_metrics.csv``

Artifacts
---------

- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes.png``
- ``docs/readthedocs/source/_static/capability_gallery/simulation_comparison/ex12_multi_simulation_moderate_causes_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
