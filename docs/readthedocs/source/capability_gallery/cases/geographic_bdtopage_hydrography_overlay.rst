...
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_bdtopage_hydrography_overlay.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_bdtopage_hydrography_overlay_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
