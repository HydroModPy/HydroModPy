...
- reference: steady no-recharge Boussinesq relation on `b(x)` above a linear substratum, solved through its implicit integral law,

.. math::

   q=K\,b\left(S_0-\frac{\mathrm{d}b}{\mathrm{d}x}\right),\qquad S_0=-\frac{\mathrm{d}z_b}{\mathrm{d}x}

.. math::

   x-x_{\min}=\int_{b_w}^{b(x)} \frac{K\,\beta\,\eta-q}{K\,\beta^2}\,\mathrm{d}\eta,\qquad \beta=S_0,\qquad H(x)=z_b(x)+b(x)
...
.. tab-set::
   ...
   .. tab-item:: MODFLOW-NWT
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflownwt.png
         ...
         Boussinesq Sloping-Substratum Fixed-Head 1D rendered with MODFLOW-NWT for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0146 m
      - Head-profile max abs error: 0.0215 m
      - Cross-row head spread: 4.67e-07 m
      - Reference discharge per width: 1.942e-05 m2/s

      - Config file: ``validation_cases/analytical/steady/boussinesq_sloping_substratum_fixed_head_1d/config_modflownwt.toml``
      - Tolerances: ``validation_cases/analytical/steady/boussinesq_sloping_substratum_fixed_head_1d/tolerances.toml``
   ...
   .. tab-item:: MODFLOW 6
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflow6.png
         ...
         Boussinesq Sloping-Substratum Fixed-Head 1D rendered with MODFLOW 6 for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0006 m
      - Head-profile max abs error: 0.0008 m
      - Cross-row head spread: 4.05e-06 m
      - Reference discharge per width: 1.942e-05 m2/s

      - Config file: ``validation_cases/analytical/steady/boussinesq_sloping_substratum_fixed_head_1d/config_modflow6.toml``
      - Tolerances: ``validation_cases/analytical/steady/boussinesq_sloping_substratum_fixed_head_1d/tolerances_modflow6.toml``
      - Expected shape: 5 x 40

      .. code-block:: bash

         python -m validation_cases.analytical.steady.boussinesq_sloping_substratum_fixed_head_1d.run_case --no-show --solver modflow6
   ...
   .. tab-item:: MODFLOW 6 irregular triangles
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflow6_irregular_tri.png
         ...
         Boussinesq Sloping-Substratum Fixed-Head 1D rendered with MODFLOW 6 irregular triangles for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0695 m
      - Head-profile max abs error: 0.1641 m
      - Cross-row head spread: 1.78e-15 m
      - Reference discharge per width: 1.942e-05 m2/s

      - Config file: ``validation_cases/analytical/steady/boussinesq_sloping_substratum_fixed_head_1d/config_modflow6_irregular_tri.toml``
      - Tolerances: ``validation_cases/analytical/steady/boussinesq_sloping_substratum_fixed_head_1d/tolerances_modflow6_irregular_tri.toml``
      - Expected shape: 5 x 40

      .. code-block:: bash

         python -m validation_cases.analytical.steady.boussinesq_sloping_substratum_fixed_head_1d.run_case --no-show --solver modflow6_irregular_tri
   ...
   .. tab-item:: Boussinesq
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__boussinesq.png
         ...
         Boussinesq Sloping-Substratum Fixed-Head 1D rendered with Boussinesq for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0056 m
      - Head-profile max abs error: 0.0127 m
      - Cross-row head spread: 1.62e-10 m
      - Reference discharge per width: 1.942e-05 m2/s
      ...
      .. code-block:: bash
         ...
         python -m validation_cases.analytical.steady.boussinesq_sloping_substratum_fixed_head_1d.run_case --no-show --solver boussinesq
...
.. code-block:: bash
   ...
   python -m validation_cases.analytical.steady.boussinesq_sloping_substratum_fixed_head_1d.run_case --no-show
...
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflownwt.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflow6.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflow6_irregular_tri.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__boussinesq.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
