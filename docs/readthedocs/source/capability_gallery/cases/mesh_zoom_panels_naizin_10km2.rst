...
- ``docs/readthedocs/source/_static/capability_gallery/mesh/mesh_zoom_panels_naizin_10km2.png``
- ``docs/readthedocs/source/_static/capability_gallery/mesh/mesh_zoom_panels_naizin_10km2_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
