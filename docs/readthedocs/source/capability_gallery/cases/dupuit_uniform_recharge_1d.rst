...
.. tab-set::
   ...
   .. tab-item:: MODFLOW 6 irregular triangles
      ...
      .. figure:: /_static/capability_gallery/validation/dupuit_uniform_recharge_1d__modflow6_irregular_tri.png
         :alt: Dupuit Uniform Recharge 1D validation figure for MODFLOW 6 irregular triangles
         :width: 100%

         Dupuit Uniform Recharge 1D rendered with MODFLOW 6 irregular triangles for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0295 m
      - Head-profile max abs error: 0.0464 m
      ...
      - Tolerances: ``validation_cases/analytical/steady/dupuit_uniform_recharge_1d/tolerances_modflow6_irregular_tri.toml``
      - Expected shape: 5 x 40

      .. code-block:: bash

         python -m validation_cases.analytical.steady.dupuit_uniform_recharge_1d.run_case --no-show --solver modflow6_irregular_tri
   ...
   .. tab-item:: Boussinesq
      ...
      **Metrics**
      - Head-profile RMSE: 0.0254 m
      - Head-profile max abs error: 0.0370 m
      - Cross-row head spread: 1.98e-10 m
...
- ``docs/readthedocs/source/_static/capability_gallery/validation/dupuit_uniform_recharge_1d__modflow6_irregular_tri.png``
