...
.. tab-set::
   ...
   .. tab-item:: MODFLOW-NWT
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d__modflownwt.png
         ...
         Boussinesq Sloping-Substratum Uniform-Recharge 1D rendered with MODFLOW-NWT for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0290 m
      - Head-profile max abs error: 0.0410 m
   ...
   .. tab-item:: MODFLOW 6
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d__modflow6.png
         ...
         Boussinesq Sloping-Substratum Uniform-Recharge 1D rendered with MODFLOW 6 for the analytical gallery.

      **Metrics**
      - Head-profile RMSE: 0.0091 m
      - Head-profile max abs error: 0.0125 m
      - Cross-row head spread: 3.85e-06 m
      - Reference west discharge per width: 1.734e-05 m2/s
      - Reference east discharge per width: 2.196e-05 m2/s
   ...
   .. tab-item:: Boussinesq
      ...
      **Metrics**
      - Head-profile RMSE: 0.0057 m
      - Head-profile max abs error: 0.0142 m
      - Cross-row head spread: 2.24e-10 m
      - Reference west discharge per width: 1.734e-05 m2/s
      - Reference east discharge per width: 2.196e-05 m2/s
...
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d__modflownwt.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d__modflow6.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d__modflow6_irregular_tri.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d__boussinesq.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_uniform_recharge_1d_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
