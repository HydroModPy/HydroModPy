...
.. tab-set::
   ...
   .. tab-item:: MODFLOW-NWT
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__modflownwt.png
   ...
   .. tab-item:: MODFLOW 6
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__modflow6.png
   ...
   .. tab-item:: MODFLOW 6 irregular triangles
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__modflow6_irregular_tri.png
      ...
      **Metrics**
      - Head-profile RMSE: 0.0385 m
      - Head-profile max abs error: 0.0798 m
   ...
   .. tab-item:: Boussinesq
      ...
      .. figure:: /_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__boussinesq.png
      ...
      **Metrics**
      - Head-profile RMSE: 0.0029 m
      - Head-profile max abs error: 0.0048 m
      - Cross-row head spread: 7.12e-11 m
      - Reference discharge per width: 1.000e-05 m2/s
...
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__modflownwt.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__modflow6.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__modflow6_irregular_tri.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d__boussinesq.png``
- ``docs/readthedocs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_constant_thickness_1d_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
