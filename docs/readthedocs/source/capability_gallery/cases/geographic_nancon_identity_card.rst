...
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_map_dem.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_map_hydrography.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_map_geology.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_station_inventory.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_stats_card.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_climatic_summary.png``
- ``docs/readthedocs/source/_static/capability_gallery/geographic/geographic_nancon_identity_card_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
