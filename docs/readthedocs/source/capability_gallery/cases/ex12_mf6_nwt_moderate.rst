...
.. code-block:: bash
   ...
   python -m launchers method-comparison run examples_legacy_2/projects/launcher_simulation/run_method_comparison_mf6_vs_nwt_different_meshes_moderate.toml
