...
.. tab-set::
   ...
   .. tab-item:: MODFLOW 6 irregular triangles
      ...
      **Metrics**
      - Head-profile RMSE: 0.0204 m
      - Head-profile max abs error: 0.0322 m
      - Cross-row head spread: 8.88e-16 m
      - Min numerical clearance above topography: 0.0800 m
   ...
   .. tab-item:: MODFLOW 6 irregular triangles
      ...
      .. list-table::
         ...
         * - ``mesh_input.mesh_path``
           ...
           - ../../../shared/mesh_bundles/linearized_unconfined_hillslope_drainage_irregular_tri_100x10/mesh_2d.msh
           - ``validation_cases/analytical/steady/linearized_unconfined_hillslope_drainage_1d/config_modflow6_irregular_tri.toml``
         * - ``mesh_input.bundle_dir``
           ...
           - ../../../shared/mesh_bundles/linearized_unconfined_hillslope_drainage_irregular_tri_100x10
           - ``validation_cases/analytical/steady/linearized_unconfined_hillslope_drainage_1d/config_modflow6_irregular_tri.toml``
...
- ``docs/source/_static/capability_gallery/validation/linearized_unconfined_hillslope_drainage_1d__modflownwt.png``
- ``docs/source/_static/capability_gallery/validation/linearized_unconfined_hillslope_drainage_1d__modflow6.png``
- ``docs/source/_static/capability_gallery/validation/linearized_unconfined_hillslope_drainage_1d__modflow6_irregular_tri.png``
- ``docs/source/_static/capability_gallery/validation/linearized_unconfined_hillslope_drainage_1d_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
