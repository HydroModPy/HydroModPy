...
- ``docs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflownwt.png``
- ``docs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflow6.png``
- ``docs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__modflow6_irregular_tri.png``
- ``docs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d__boussinesq.png``
- ``docs/source/_static/capability_gallery/validation/boussinesq_sloping_substratum_fixed_head_1d_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
