...
.. list-table::
   ...
   * - ``crs``
     ...
     - EPSG:2154
     - ``docs/source/_static/capability_gallery/mesh/mesh_headwater_100km2_outlet_3_geology_rivers_buffer30_summary.json``
   * - ``node_count``
...
- ``docs/source/_static/capability_gallery/mesh/mesh_headwater_100km2_outlet_3_geology_rivers_buffer30_overview.png``
- ``docs/source/_static/capability_gallery/mesh/mesh_headwater_100km2_outlet_3_geology_rivers_buffer30_regional.png``
- ``docs/source/_static/capability_gallery/mesh/mesh_headwater_100km2_outlet_3_geology_rivers_buffer30_summary.json`` stores the displayed metrics plus source hashes used by ``python -m tools.doc_gallery --check``.
