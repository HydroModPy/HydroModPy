...
- :doc:`simulation_catalog_architecture <storage>` : couche de stockage.
- :doc:`frontend_hooks <frontend_hooks>` : intégration des frontaux externes.
- :doc:`glossary <glossary>` : conventions de nommage.
