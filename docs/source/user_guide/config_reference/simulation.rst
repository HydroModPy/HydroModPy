...
`Source on GitHub <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L321>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str` :bdg-secondary:`default = ""` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L331>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`list[str]` :bdg-info:`factory` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L384>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str` :bdg-secondary:`default = "version"` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L388>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str` :bdg-secondary:`default = ""` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L376>`__

      Short free-text description of the simulation intent.


.. index:: ! scientific_objective
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L404>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L408>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L412>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`str | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L416>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`float | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L420>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`float | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L424>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`SimulationTimeConfig | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L328>`__
   ...
   .. dropdown:: Fields of ``SimulationTimeConfig``
      ...
      .. container:: hmp-field hmp-field-level-user
         ...
         :bdg-primary:`Optional[str]` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L82>`__
      ...
      .. container:: hmp-field hmp-field-level-dev
         ...
         :bdg-primary:`int` :bdg-secondary:`default = 1` :bdg-warning:`dev` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L107>`__

            Number of solver time steps within each stress period, the one knob that buys transient accuracy. The default of 1 integrates a whole period in a single backward-Euler step, which is not a neutral choice: on a seasonally recharged hillslope drained by DRN cells it moves the monthly discharge by 4 to 28 % against a refined run, across the whole plausible bedrock range, and a calibration scored on discharge absorbs that into the fitted parameters. The right count compares the aquifer response time `tau = L^2 S / (K b)` with the period length, and the solver cost is linear in it; 30 gives daily steps inside monthly periods. Consumed by the MODFLOW backends as DIS NSTP / TDIS nstp; the Boussinesq backend has its own [flow].vi_substeps_per_period.
      ...
      .. container:: hmp-field hmp-field-level-dev
         ...
         :bdg-primary:`str` :bdg-secondary:`default = "error"` :bdg-warning:`dev` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L125>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`type = "flow" | "transport" | "mesh"` :bdg-info:`factory` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L351>`__
      ...
      .. tab-item:: flow
         ...
         .. rst-class:: hmp-config-fields hmp-config-fields-nested
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`str` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L198>`__
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`list[str]` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L205>`__
      ...
      .. tab-item:: transport
         ...
         .. rst-class:: hmp-config-fields hmp-config-fields-nested
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`str` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L234>`__
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`list[str]` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L241>`__
      ...
      .. tab-item:: mesh
         ...
         .. rst-class:: hmp-config-fields hmp-config-fields-nested
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`str` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L270>`__
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`Literal['catchment']` :bdg-secondary:`default = "catchment"` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L277>`__
            ...
            .. container:: hmp-field hmp-field-level-user
               ...
               :bdg-primary:`list[str]` :bdg-info:`factory` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L284>`__
...
.. container:: hmp-field hmp-field-level-dev
   ...
   :bdg-primary:`ResultsConfig` :bdg-info:`factory` :bdg-warning:`dev` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L444>`__
   ...
   .. dropdown:: Fields of ``ResultsConfig``
      ...
      .. container:: hmp-field hmp-field-level-user
         ...
         .. dropdown:: Fields of ``DerivedConfig``
            ...
            .. index:: ! release_accumulation_flux
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`int | None` :bdg-secondary:`default = None` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/main/hydromodpy/simulation/planning/config.py#L452>`__
