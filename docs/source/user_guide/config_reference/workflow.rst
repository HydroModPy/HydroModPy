...
`Source on GitHub <https://github.com/HydroModPy/HydroModPy/blob/master/hydromodpy/config/hydromodpy_config.py#L84>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`Literal['simulation', 'calibration', 'overview', 'comparison', 'testbed']` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/master/hydromodpy/config/hydromodpy_config.py#L87>`__
