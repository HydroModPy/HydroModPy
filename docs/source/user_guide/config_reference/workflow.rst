...
`Source on GitHub <https://github.com/HydroModPy/HydroModPy/blob/master/hydromodpy/config/hydromodpy_config.py#L86>`__
...
.. container:: hmp-field hmp-field-level-user
   ...
   :bdg-primary:`Literal['simulation', 'calibration', 'batch', 'overview', 'mesh', 'comparison', 'testbed']` :bdg-danger:`required` :bdg-success:`user` `source <https://github.com/HydroModPy/HydroModPy/blob/master/hydromodpy/config/hydromodpy_config.py#L89>`__
