...
- ``docs/source/scientific/mesh/render_mesh_comparison_assets.py``
- ``docs/source/scientific/mesh/render_regular_irregular_case_assets.py``
...
- ``docs/source/_static/scientific/mesh/regular_irregular_cases/*.png``
- ``docs/source/_static/scientific/mesh/regular_irregular_cases/regular_irregular_case_summary.json``
