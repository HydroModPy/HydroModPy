...
# PARAMS PATHS
    ...
    # CFG - conmfiguration - Grid and climate data paths
    CFG = Paths(
    ...
    for i in df.index:
        ...
        if OPT.make_climate and int(df.at[i, "local_climate"]) == 0:
            ...
            preprocess_climate_inputs(climate_map =climate_map, workdir = sp.results_pyhelp, decimals=1, date_window=DATE_WINDOW, logger=logger)
