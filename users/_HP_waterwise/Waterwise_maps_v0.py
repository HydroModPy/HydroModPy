...
sites_file = os.path.join(data_path,'_sites','Waterwise_sites_may2025.xlsx')
...
for i, j in sites.iterrows():
    ...
    try:    
        ...
        print(f"⚠️ Could not run the visualization_watershed for {id_name}: {e}")
    ...
    try:
        ...
        print(f"⚠️ Could not add the geology for {id_name}: {e}")
