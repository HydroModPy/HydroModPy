...
@author: delarueo
modified to extract alps data from wind and humidity
"""
...
def process_and_save_buffer(buffer_folder, data, b_inf, b_sup):
    """
...
input_path = 'F:/_cerra_land/'
output_path = 'D:/_cerra_land_tp/'
list_files = ['20012022']#['19842000','20012022']
...
n_buffer = 1000  # Number of time steps in a buffer (max 1000)
...
for var in variables:    
    for file in list_files:
        ...
        file_path = f'{folder_path}{file}.nc'
        alps_file_path = f'{output_path}{file}_alps.nc'
        buffer_folder = f'{folder_path}buffer/'
        ...
        if os.path.isfile(file_path):
            ...
            list_buffer_path = process_and_save_buffer(buffer_folder, data, b_inf, b_sup)
