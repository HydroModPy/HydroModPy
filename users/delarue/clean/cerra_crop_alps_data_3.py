...
input_path = 'F:/_cerra_forecast/May-07-2025/'
output_path = 'Z:/_waterwise_data_process/_climate/_cerra_forecast/'
years = range(1984, 2023)
variables = ['2m_temperature', 'total_precipitation',
             'snow_depth', 'snow_depth_water_equivqlent',
...
for var in variables:    
    for year in years:
        ...
        # Define file paths
        folder_path = f'{input_path}{var}/'
        file_path = f'{folder_path}{year}/{year}.nc'
        alps_file_path = f'{output_path}{year}/{year}_alps.nc'
