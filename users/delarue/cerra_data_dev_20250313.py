...
# polygon = Polygon([(9.980,46.315),(9.995,46.315),(9.995,46.330),(9.980,46.330),(9.980,46.315)])
# point = Point(((9.980,46.350)))



#%%

# TODO find pixel in polygon or closest (or closest to point)
polygon_path = f'M:/crash_zone/catchements/watershed_jamt.shp'
...
#%%
fig,ax = plot_grid_points_near_polygon(grid, polygon, distance_threshold = 0.02,
                                       method='polygon', display = False)
...
print(nearest_idx)
#%%      
def find_grid_points_near(grid, obj, distance_threshold=0.05,  display = True):
