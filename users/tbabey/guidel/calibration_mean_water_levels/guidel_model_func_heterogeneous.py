...
def func_objguidel(x,args):
    ...
    print('nRMSE for K_alt='+str(K1111)+'m/s, K_deep='+str(K2222)+'m/s ='+str(nrmse)+'.')
...
# logK1111min = -7
# logK1111max = -4
# K1111 = np.logspace(logK1111min,logK1111max,num=30)
# logK1111 = np.log10(K1111)

# logK2222min = -6
# logK2222max = -4
# K2222 = np.logspace(logK2222min,logK2222max,num=20)
...
# res = np.zeros((len(logK1111),len(logK2222)))

# for i in list(range(len(K1111))):
#     for j in list(range(len(K2222))):
#         res[i,j] = func_objguidel((logK1111[i],logK2222[j]),BV)
...
bestK1111 = temp[0]
bestK2222 = float(temp[1])


res1, wellref, comparedf, shrenv = func_objguidel_full((np.log10(bestK1111),np.log10(bestK2222)),BV)
...
plt.savefig('C:/Users/trist/Documents/research/Guidel/calibration/results_hetero2l-piezos.jpg',
            bbox_inches='tight')
plt.show()
