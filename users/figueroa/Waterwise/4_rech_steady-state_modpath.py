...
site_num = 3            #indicate number of study site
...
list_hyd_cond = np.geomspace(2.5e-1,4e-1,5)
...
for model_name, model_success, model_modflow in zip(list_model_name[:],
    ...
    BV.settings.update_input_particles(
                                        ...
                                        cell_div = 1, # 1, distribution of partciles by cell in x and y direction
...
compt = 0
stream_obs=gpd.read_file('D:/Dropbox/1_CHYN_Neuchatel/2WATERWISE/Study_sites/shapefiles/Rechy_stream_network.shp')
