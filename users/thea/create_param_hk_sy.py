...
if __name__ == "__main__": # permet d'executer cette section de code uniquement dans le fichier principal create_param_hk_sy.py
    # Example 1: Recreate your original parameters
    print("25_25_grid_(hk, sy)")
    original_config = {
        'hk': {'min': 1e-8, 'max': 1e-2, 'resolution': 25, 'scale': 'log'},
        'sy': {'min': 1e-3, 'max': 10, 'resolution': 25, 'scale': 'log'}
    }
    df1, info1 = quick_generate(original_config, num_files=8, output_dir = r"C:\Users\theat\Documents\Python\01_Git_Repository\01-HMPdev-sewage\users\thea\parameters")
# %%
