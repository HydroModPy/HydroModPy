...
first_year = 1981
last_year = 2024
parameters = '30_10e-4_10e-5_10values_0.1'
...
watershed_name = '_'.join([
    "Example_03_REA",study_site,parameters,str(first_year),str(last_year)
])
...
from_xyv = [341867,6793672, 150, 10 , 'EPSG:2154'] # [x, y, snap distance, buffer size, crs proj]
...
########## LOOP ##########
list_hyd_cond = np.geomspace(1e-4,1e-5,10) * 24 * 3600 # m/day #* geomspace = fonction de numpy pour générer 10 valeurs a intervalle égale entre les deux bornes données
...
#%% CROSS
#* va sortir toutes les watertable elevation par rapport aux valeurs de k en entrée #paramétrization
